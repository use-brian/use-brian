...
describe('[COMP:brain/ingest-tools] addIngestRule', () => {
  ...
  it('inherits the active TurnScope and observed evidence for new rules', async () => {
    const store = makeFakeStore()
    const { addIngestRule } = createIngestRuleTools(store)
    const scopedCtx: ToolContext = {
      ...
      assistantDefaultCompartments: ['team:11111111-1111-4111-8111-111111111111'],
      assistantDefaultProjectIds: ['22222222-2222-4222-8222-222222222222'],
      scopeAccumulator: new ContextScopeAccumulator({
        sensitivity: 'internal',
        compartments: ['team:33333333-3333-4333-8333-333333333333'],
    ...
    expect(input.compartments).toEqual([
      'team:11111111-1111-4111-8111-111111111111',
      'team:33333333-3333-4333-8333-333333333333',
    ])
