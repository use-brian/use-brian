...
- Go easy on the em dash ("—"). Overusing it is an AI tell that real people rarely write. Reach for a comma, a period, parentheses, or a colon instead, and keep "—" for the rare case nothing else fits.
