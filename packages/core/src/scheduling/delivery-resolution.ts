 ...
 */
const DELIVER_CHANNELS = ['web', 'telegram', 'slack', 'whatsapp', 'msteams', 'custom', 'feishu'] as const
...
const MESSAGING_CHANNELS = new Set(['telegram', 'slack', 'whatsapp', 'msteams', 'custom', 'feishu'])

/** Messaging channel types the model may name as a delivery target. */
export type MessagingChannel = 'telegram' | 'slack' | 'whatsapp' | 'msteams' | 'custom' | 'feishu'
