...
function gmailApi(): { api: GmailApi; sent: Array<{ to: string[]; cc?: string[]; bcc?: string[]; from?: string; subject: string; body: string }> } {
  const sent: Array<{ to: string[]; cc?: string[]; bcc?: string[]; from?: string; subject: string; body: string }> = []
  const api: GmailApi = {
    listMessages: vi.fn(),
    getMessage: vi.fn(),
