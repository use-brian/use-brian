...
export const setHomeDockInputSchema = z.object({
  ...
  needsYou: z
    ...
    .optional()
    .describe(
      'The "Needs you" action cards in priority order. Include only the kinds worth surfacing today; counts are filled in live, so a kind whose count is 0 is dropped automatically.',
    ),
})
