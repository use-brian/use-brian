...
// PendingQuestionPanel moved to `pending-question-panel.tsx` so the Chat
// operator surface renders the same panel in a room transcript (multiplayer
// chat T11/D8). Imported above.
