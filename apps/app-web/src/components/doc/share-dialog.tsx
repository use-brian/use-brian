...
function SlugRow({
  ...
  return (
    <div className="space-y-1.5 border-t border-border pt-3">
      ...
      <div className="flex items-center gap-2">
        <div className="flex min-w-0 flex-1 items-center rounded-md border border-border bg-background text-sm transition-[border-color,box-shadow] focus-within:border-ring [&_:focus-visible]:shadow-none">
