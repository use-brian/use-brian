      ...
      <Dialog.Portal>
        ...
        >
          ...
          <div className="px-4 pb-2 pt-2">
            ...
            <div className="flex items-center gap-2 rounded-md border border-border bg-muted/40 px-2.5 py-1.5 transition-[border-color,box-shadow] focus-within:border-ring [&_:focus-visible]:shadow-none">
