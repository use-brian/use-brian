...
const run = (n: number, text: string): OfficeRichTextRun => ({ id: uid(n), text, style: { fontFamily: "Arial", fontSizePt: 12, bold: false, italic: false, underline: false, strike: false, color: "#111111" } });
