 ...
 * the `BrowsersSurfaceShell` (operator top bar + live-session rail). The rail
 * persists across `/computer/<sessionId>` transitions, so navigating between
 * sessions never remounts the chrome. See computer-use.md §5.
 *
