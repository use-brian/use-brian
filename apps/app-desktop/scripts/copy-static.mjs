...
// preload (`preload.cjs`) and the sign-in landing (`signin.html`) — from src/ into
// dist/. Run after `tsc` by the `build` / `dev` scripts.
//
...
for (const file of ["preload.cjs", "signin.html"]) {
