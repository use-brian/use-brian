...
describe('[COMP:platform/local-message-store-lifecycle] local message-store lifecycle', () => {
  test('discovers the sibling Go checkout', () => {
  ...
  test('prefers an explicit binary', () => {
    const result = resolveMessageStoreLaunch({
      root,
  ...
  test('explicit enable fails when missing', () => {
    assert.throws(
